  ...
  <div class="pengding">
    ...
    <el-card class="box-card">
      <el-table border style="width: 100%;" :data="tableForm">
        ...
        <el-table-column  prop="ifsheet" label="退件仓到仓时间"></el-table-column>
        <el-table-column  prop="ifsheet" label="申请下架销毁时间"></el-table-column>
        <el-table-column  prop="remarks" label="收费"></el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <!-- 点击编辑进入编辑页面进行编辑表格数据 -->
            <el-button size="small">完成销毁</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
