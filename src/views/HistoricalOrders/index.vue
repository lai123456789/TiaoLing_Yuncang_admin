<template>
  <div class="pengding">
    <el-card class="box-card clearfix">
          ...
          <div class="fr"><el-button type="primary">导出表格</el-button></div>
    </el-card>
    <!-- 下面卡片 -->
    <el-card class="box-card">
      <el-table border style="width: 100%;" :data="tableForm">
        ...
        <el-table-column  prop="Waybill_Num" label="收费"></el-table-column>
        <el-table-column  prop="Waybill_Num" label="状态"></el-table-column>
